//Hecho por Andres Isai Vasquez Vasquez 
#include <iostream>
#include <conio.h>
#include <stdlib.h>
	...
	do{
		...
		switch(opcion){
			...
			case '2':
				...
				while(aux !=NULL){
					cout<<aux->banca.ntickets<<"\t"<<aux->banca.ncuenta<<"\t\t\t"<<aux->banca.edad<<endl;
					aux=aux->siguiente;
				}
				break;
			case '3':
...
void agregarDatos(ICO &banca){
	cout<<"Ingresar tiket del ahorrante: "; cin.getline(banca.ntickets,5,'\n');
    
	cout<<"Ingresar numero de cuenta del ahorrante: "; cin.getline(banca.ncuenta,5,'\n');
